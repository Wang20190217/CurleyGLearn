...
![新增数据源](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271701996.png)

然后，手动将如下表拷贝到 `ruoyi-vue-pro` 主库中的如下表，拷贝到 `ruoyi-vue-pro-tenant-a` 库中。如下图所示：

![拷贝表结构到数据源](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271701185.png)
...
![新增租户](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271701476.png)

此时，在 `ruoyi-vue-pro-tenant-a` 库中，可以查询到对应的租户管理员、角色等信息。如下图所示：

![查询用户](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271701982.png)

③ 退出系统，登录刚创建的租户。

![登录界面](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271701124.png)
...
![主库](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271701765.png)

② 对应 `master` 数据源，配置在 `application-{env}.yaml` 配置文件。如下图所示：

![ 数据源](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271701340.png)
...
![ 注解](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271701915.png)
...
![ 注解](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271702485.png)
...
![使用示例](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271707121.png)
