...
在标准的 RESTful API 的定义，是推荐使用 [HTTP 响应状态码 ](https://zh.wikipedia.org/wiki/HTTP状态码)作为状态码。一般来说，我们实践很少这么去做，主要原因如下：
...
[`curleyg` ]项目在实践时，将状态码放在 Response Body 响应内容中返回。一共有 3 个字段，通过 [CommonResult ]定义如下：

![CommonResult](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412271953287.png)
...
![CommonResult](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272005735.png)
...
![GlobalExceptionHandler 异常处理](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272005799.png)

### 2.2 Filter 的异常

在请求被 Spring MVC 处理之前，是先经过 Filter 处理的，此时发生异常时，是无法通过 `@ExceptionHandler` 注解来处理的。只能通过 `try catch` 的方式来实现，代码如下：

![Filter 异常处理](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272005963.png)
...
![ServiceException 业务异常](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272005866.png)
...
![ServiceException 业务异常](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272005260.png)
...
![错误码](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272005233.png)
...
![GlobalErrorCodeConstants 类](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272005335.png)
...
![ServiceErrorCodeRange 类](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272005757.png)

② 每个业务模块，定义自己的 ErrorCodeConstants 错误码枚举类。以 `curleyg-module-system` 模块举例子，代码如下：

![ErrorCodeConstants 类](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272005073.png)
...
![系统管理 -> 错误码管理](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272006708.png)
...
![系统管理 -> 错误码管理](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272006143.png)

#### 4.2.2 自动添加

通过 `curleyg.error-code.constants-class-list` 配置项，设置需要自动添加的 ErrorCodeConstants 错误码枚举类。如下图所示：

![ 配置项](https://curleyg-1311489005.cos.ap-shanghai.myqcloud.com/202412272006238.png)
