...
## [#](https://doc.iocoder.cn/mall/trade-cart/#_1-表结构)1. 表结构
...
当然，如果你真的希望使用 Redis 实现购物车，推荐阅读 [《购物车服务》 (opens new window)](http://skrshop.tech/#/src/shopping/cart?id=购物车服务)文档。

## [#](https://doc.iocoder.cn/mall/trade-cart/#_2-管理后台)2. 管理后台

暂时没有对应菜单，可以查询 `trade_cart` 表实现。

因为它采用 MySQL 实现存储，所以实现还是比较简单的。如果是 Redis 的话，可能条件 + 分页查询就比较复杂了。

## [#](https://doc.iocoder.cn/mall/trade-cart/#_3-移动端)3. 移动端

### [#](https://doc.iocoder.cn/mall/trade-cart/#_3-1-添加购物车)3.1 添加购物车
...
### [#](https://doc.iocoder.cn/mall/trade-cart/#_3-2-购物车列表)3.2 购物车列表
