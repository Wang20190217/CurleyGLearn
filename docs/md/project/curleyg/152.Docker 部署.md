...
#### [#](https://doc.iocoder.cn/deployment-docker/#第一步-创建挂载目录)第一步，创建挂载目录
...
## [#](https://doc.iocoder.cn/deployment-docker/#_3-部署前端)3. 部署前端
...
### [#](https://doc.iocoder.cn/deployment-docker/#_4-1-方式一-服务器-ip-访问)4.1 方式一：服务器 IP 访问
